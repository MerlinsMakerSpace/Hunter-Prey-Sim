...
class Feld ():
    ...
    def __init__ (self):
        ...
        print('Geben sie die folgenden Attribute für die Simulation ein.')

        self.NOC=int(input('Anzahl Durchläufe: '))

        self.GdF=int(input('Seitenlänge: '))
        self.SF=int(input('Startzahl Füchse: '))
        self.SH=int(input('Startzahl Hasen: '))

        
        self.MAF=int(input('Maximales Fuchsalter: '))
        self.MF=int(input('Reifealter Fuchs: '))
        self.max_food=int(input('Maximales Futterlevel Fuchs: '))
        self.CF=int(input('Anzahl Fuchskinder in einem Wurf: '))
        self.RF=int(input('Wahrscheinlichkeit, dass sich ein Fuchs vermehrt: '))
        
        self.MAH=int(input('Maximales Hasenalter: '))
        self.MH=int(input('Reifealter Hase: '))
        self.CH=int(input('Anzahl Hasenkinder in einem Wurf: '))
        self.RH=int(input('Wahrscheinlichkeit, dass sich ein Hase vermehrt: '))
